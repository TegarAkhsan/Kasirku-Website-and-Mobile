...
# Aplikasi POS SaaS (Bahasa Indonesia)
...
3.  **Konfigurasi Environment**:
    ...
    cp .env.example .env
    ```
    Buka file `.env` dan pastikan `BASE_URL` sesuai dengan URL backend Anda (misal: `http://10.0.2.2:8000/api` untuk emulator, atau IP LAN Anda untuk device fisik).
